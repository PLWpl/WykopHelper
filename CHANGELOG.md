...
* Dodatkowo, w popupie usera można zadecydować o wrzuceniu usera na czarną listę. Ale ostrożnie - po zczarnolistowaniu, posty danego użytkownika będą całkowicie usuwane, a nie tylko chowane jak w wykopowej czarnej liście. Później - aby użytkownikowi wybaczyć, i z czarnej listy go zdjąć - należy udać się do jego profilu (wykop.pl/ludzie/NICK) i kliknąć na ikonę kłódki przy jego nicku.

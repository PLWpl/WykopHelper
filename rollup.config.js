  ...
  output: [
    ...
    },
    {
      ...
      plugins: [
        ...
        banner('@downloadURL  https://cdn.jsdelivr.net/gh/plwpl/WykopHelper@develop/dist/whhelper-dev.user.js'),
        banner('@updateURL    https://cdn.jsdelivr.net/gh/plwpl/WykopHelper@develop/dist/whhelper-dev.user.js'),
        banner('@version      <%= pkg.version %>'),
